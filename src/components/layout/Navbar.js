    ...
    render(){
        ...
        const authLinks = (
            <ul className="navbar-nav">
                <span className="fas fa-user-circle profile"><span className="username">{student.name} {student.surname}</span></span>
        ...
        return(
            <nav className="navbar navbar-default">
                <i className="navbar-brand">Classroom Management </i>
                <div className="menus">
